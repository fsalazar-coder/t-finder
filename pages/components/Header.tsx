...
export default function Header(props: any) {
  ...
  return (
    <div className='w-full h-full px-2 lg:px-8 relative flex flex-col justify-center items-center bg-sky-100'>

      {/**Title text */}
      <div className='w-full h-fit flex flex-col justify-center items-center z-[35]'>
        <h3 className='w-fit h-fit text-color-text-medium text-sm sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl tracking-wide font-normal flex'>
          The real app that
        </h3>
        <h1 className='w-fit h-fit text-color-highlighted-dark text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-5xl tracking-wide font-bold drop-shadow-2xl flex z-30'>
          <Typewriter
      ...
      {/**Subtitle text */}
      <div className='w-full h-fit flex flex-col justify-center items-center z-[35]'>
        <h5 className='w-fit h-fit text-color-highlighted text-sm sm:text-xs md:text-sm lg:text-base xl:text-lg font-medium tracking-wider text-start py-1 flex flex-col justify-start'>
