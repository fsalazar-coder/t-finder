...
export default function ButtonGoTo() {
  ...
  return (
    <button
      className='w-fit h-fit px-8 py-3 text-slate-50 hover:text-white md:hover:font-bold flex flex-row justify-center items-center bg-color-highlighted lg:bg-opacity-75 lg:hover:bg-opacity-100 rounded-full cursor-pointer transform hover:scale-[1.1] transition-all z-30'
      onClick={handleClick}
    >
