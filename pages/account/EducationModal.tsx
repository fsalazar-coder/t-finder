...
export default function EducationModal(props: any) {
  ...
  const profileInput = [
    ...
    { type: 'date', title: 'Birthday (optional)', value: 'birthday' },
              ...
              >
                ...
                >
                  <div className='w-full h-full flex flex-col items-center'>
                    {/**profile form I */}
                    <TemplateForm
                      inputData={profileInput.slice(0, 5)}
              ...
              >
                ...
                >
                  <div className='w-full h-full flex flex-col items-center'>
                    {/**profile form II */}
                    <TemplateForm
                      inputData={profileInput.slice(5)}
                      formData={dataProfile}
                      changeData={changeDataProfile}
                      onChange={(e: any) => handleChangeData(e)}
                      onFocus={(e: any) => setChangeDataProfile({ ...changeDataProfile, [e.target.name]: true })}
